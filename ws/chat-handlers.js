  ...
  switch (msg.type) {
    ...
    case 'chat-history': {
      ...
      try {
        ...
        ws.send(JSON.stringify({ type: 'chat-history-result', sessionKey, messages: result.messages || [], thinkingLevel: result.thinkingLevel, verboseLevel: result.verboseLevel }));
      } catch (err) {
