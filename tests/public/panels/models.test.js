...
describe('render', () => {
  ...
  it('renders model bars from live-weekly contract and period label', () => {
    ...
    expect(el.querySelector('.models-period-label').textContent).toContain('This week (Sun → now, America/Chicago)');
  ...
  it('sorts by totalTokens descending', () => {
    HUD.models.render({
      meta: { tz: 'UTC' },
      models: [
        { provider: 'a', model: 'small', totalTokens: 100, inputTokens: 50, outputTokens: 50, cacheReadTokens: 0, totalCost: 0 },
        { provider: 'b', model: 'big', totalTokens: 9000, inputTokens: 5000, outputTokens: 4000, cacheReadTokens: 0, totalCost: 0 },
      ],
  ...
  it('hides cost when zero', () => {
    HUD.models.render({
      meta: { tz: 'UTC' },
      models: [
        { provider: 'x', model: 'model', totalTokens: 100, inputTokens: 50, outputTokens: 50, cacheReadTokens: 0, totalCost: 0 },
      ],
