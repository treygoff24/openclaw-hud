...
// Load the commands module first, then input module
...
describe('chat-commands.js', () => {
  describe('Command Registry', () => {
    ...
    it('has all required commands defined', () => {
      ...
      const required = [
        'help', 'abort', 'new', 'reset', 'model', 'think', 'verbose',
        'status', 'models', 'clear', 'export', 'session', 'save', 'load',
        'prompt', 'system', 'temp', 'max-tokens', 'reasoning', 'search',
        'web', 'recall', 'memory', 'alias', 'context', 'output', 'response',
        'provider', 'think-depth', 'max-turns', 'continue', 'retry', 'edit'
      ];
    ...
    it('categories are valid', () => {
      const validCategories = ['Session', 'Model', 'Display', 'Tools', 'Memory', 'System', 'Config'];
      const commands = window.ChatCommands.getAll();
      for (const cmd of commands) {
    ...
    it('local commands are marked correctly', () => {
      const localCommands = ['help', 'abort', 'new', 'reset', 'model', 'think', 'verbose', 'status', 'models'];
