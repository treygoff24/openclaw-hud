...
describe('Copy Buttons', () => {
  ...
  describe('Assistant Message Copy Button', () => {
    ...
    it('copies text content on click', async () => {
      const msg = { role: 'assistant', content: [{ type: 'text', text: 'Hello world' }], timestamp: new Date().toISOString() };
      const el = window.ChatMessage.renderHistoryMessage(msg);
    ...
    it('shows copied state after click', async () => {
      const msg = { role: 'assistant', content: [{ type: 'text', text: 'Test' }], timestamp: new Date().toISOString() };
      const el = window.ChatMessage.renderHistoryMessage(msg);
  ...
  describe('User Message Copy Button', () => {
    ...
    it('copies user message content', async () => {
      const msg = { role: 'user', content: [{ type: 'text', text: 'User message' }], timestamp: new Date().toISOString() };
      const el = window.ChatMessage.renderHistoryMessage(msg);
  ...
  describe('Edge cases', () => {
    ...
    it('handles empty message content', async () => {
      const msg = { role: 'assistant', content: [{ type: 'text', text: '' }], timestamp: new Date().toISOString() };
      const el = window.ChatMessage.renderHistoryMessage(msg);
