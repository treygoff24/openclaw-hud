...
function createInProcessMemoCache({ name = "inprocess-memo-cache" } = {}) {
  ...
  async function getOrSet({ key, ttlMs = 0, nowMs = Date.now(), getDependencyPaths, loader }) {
    ...
    const cacheMeta =
      computeResult &&
      typeof computeResult === "object" &&
      Object.prototype.hasOwnProperty.call(computeResult, "cacheMeta")
