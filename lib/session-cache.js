  ...
  for (const [key, value] of Object.entries(sessions)) {
    try {
      ...
      const {
        ...
        skillsSnapshot: ignoredSkillsSnapshot,
        systemPromptReport: ignoredSystemPromptReport,
        toolsSnapshot: ignoredToolsSnapshot,
        ...metadataInput
      } = base;
      normalized.push({
        ...metadataInput,
        ...
        ...helpers.enrichSessionMetadata(
          key,
          { ...metadataInput, sessionKey },
          { sessionKey, modelAliases },
        ),
      });
    } catch (error) {
